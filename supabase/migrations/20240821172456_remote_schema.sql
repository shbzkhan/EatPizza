...
COMMENT ON TABLE "public"."products" IS 'products details';
...
ALTER TABLE ONLY "public"."order_item"
    ADD CONSTRAINT "order_item_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "public"."products"("id") ON UPDATE CASCADE ON DELETE CASCADE;
...
CREATE POLICY "all authenticated user" ON "public"."orders" TO "authenticated" USING (true) WITH CHECK (true);

CREATE POLICY "all authenticated user all opration" ON "public"."order_item" USING (true) WITH CHECK (true);

CREATE POLICY "allow to authenticated users to SELECT" ON "public"."products" TO "authenticated" USING (true) WITH CHECK (true);
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."order_item";
